/* Lubayd SA V20.9.0 - control de combustible con lecturas reales y modo offline */
(function () {
  'use strict';
  ...
  function activeLoad() {
    // V20.9.0 mantiene un único control continuo. Si una versión anterior lo cerró al llegar a cero,
