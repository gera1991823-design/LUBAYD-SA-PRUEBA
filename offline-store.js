/* Lubayd SA V20.7 - usuarios locales, sesiones de 1 hora y cola de asistencia offline */
(function () {
  'use strict';
  ...
  function openDatabase() {
    ...
    databasePromise = new Promise((resolve, reject) => {
      ...
      request.onblocked = () => reject(new Error('Cierra otras pestañas de Lubayd SA y vuelve a intentarlo.'));
    });
