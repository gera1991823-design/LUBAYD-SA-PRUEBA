/* Lubayd SA V22.1.0 - aplicación principal responsive y diagnósticos */
(function () {
  'use strict';
  ...
  async function registerServiceWorker() {
    ...
    try {
      const registration = await navigator.serviceWorker.register('./service-worker.js?v=22.1.0', { scope: './' });
