...
(function () {
  ...
  function bindEvents() {
    ...
    $('#forceSyncBtn')?.addEventListener('click', async () => {
      ...
      notify('Sincronización solicitada', failed ? 'No hubo respuesta de internet; los datos continúan guardados y se reintentarán.' : 'Se procesaron las marcas y partes pendientes.', failed ? 'warning' : 'success');
    });
