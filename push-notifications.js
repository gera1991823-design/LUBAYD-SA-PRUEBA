/* Lubayd SA V21.3.0 - notificaciones push */
(function () {
  'use strict';
  ...
  async function enable() {
    ...
    bindForeground();
    localStorage.setItem('lubayd_push_enabled_v21_3', '1');
    return token;
  }
  ...
  function init() {
    ...
    window.addEventListener('lubayd-session-ready', event => { if (!event.detail.offline && localStorage.getItem('lubayd_push_enabled_v21_3') === '1') bindForeground(); });
  }
