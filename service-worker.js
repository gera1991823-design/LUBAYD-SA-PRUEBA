const CACHE='lubayd-forestal-v8.1.0';
const ASSETS=['./','./index.html','./style.css','./style-v4.css','./style-v5.css','./style-v6.css','./style-v7.css',
  './style-v8.css','./app.js','./firebase-init.js','./charts-v6.js','./manifest.json','./assets/logo.png','./assets/icon-192.png','./assets/icon-512.png'];
