/* Lubayd SA V21.3.0 - PWA offline estable */
const CACHE_NAME = 'lubayd-sa-v21.3.0-completo';
const SCOPE_URL = self.registration.scope;
const INDEX_URL = new URL('./index.html', SCOPE_URL).href;
const ROOT_URL = new URL('./', SCOPE_URL).href;
const APP_SHELL = [
  './', './index.html', './reset.html', './styles.css?v=21.3.0', './config.js?v=21.3.0', './core.js?v=21.3.0',
  './offline-db.js?v=21.3.0', './firebase-init.js?v=21.3.0', './data.js?v=21.3.0', './auth.js?v=21.3.0',
  './parts.js?v=21.3.0', './attendance.js?v=21.3.0', './breaks.js?v=21.3.0', './fuel.js?v=21.3.0',
  './chat.js?v=21.3.0', './admin.js?v=21.3.0', './push-notifications.js?v=21.3.0', './app.js?v=21.3.0',
  './manifest.webmanifest?v=21.3.0', './assets/logo.svg?v=21.3.0', './assets/icon.svg?v=21.3.0',
  './assets/icon-192.png?v=21.3.0', './assets/icon-512.png?v=21.3.0',
