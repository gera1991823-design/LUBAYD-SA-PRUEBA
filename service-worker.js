/* Lubayd SA V20.8.4 - diseño V20.1 + asistencia offline + push */
const CACHE_NAME = 'lubayd-forestal-v20.8.4-offline-completo-1h';
const LOCAL_ASSETS = [
  './',
  './index.html',
  './style.css?v=20.8.4',
  './operations.css?v=20.8.4',
  './attendance.css?v=20.8.4',
  './firebase-init.js?v=20.8.4',
  './offline-store.js?v=20.8.4',
  './push-notifications.js?v=20.8.4',
  './app.js?v=20.8.4',
  './charts.js?v=20.8.4',
  './chat.js?v=20.8.4',
  './attendance.js?v=20.8.4',
  './operations.js?v=20.8.4',
  './manifest.json?v=20.8.4',
  './assets/logo.png',
