/* Lubayd SA V20.9.0 - diseño V20.1 + asistencia offline + push */
const CACHE_NAME = 'lubayd-forestal-v20.9.0-fuel-offline';
const LOCAL_ASSETS = [
  './',
  './index.html',
  './style.css?v=20.9.0',
  './operations.css?v=20.9.0',
  './attendance.css?v=20.9.0',
  './fuel.css?v=20.9.0',
  './firebase-init.js?v=20.9.0',
  './offline-store.js?v=20.9.0',
  './push-notifications.js?v=20.9.0',
  './app.js?v=20.9.0',
  './charts.js?v=20.9.0',
  './chat.js?v=20.9.0',
  './attendance.js?v=20.9.0',
  './fuel.js?v=20.9.0',
  './operations.js?v=20.9.0',
  './manifest.json?v=20.9.0',
  './assets/logo.png',
