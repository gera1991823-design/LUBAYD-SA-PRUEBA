/* Lubayd SA V21.2.0 - diseño V20.1 + asistencia offline + push */
const CACHE_NAME = 'lubayd-forestal-v21.2.0-unified-green-ui';
const LOCAL_ASSETS = [
  './',
  './index.html',
  './style.css?v=21.2.0',
  './operations.css?v=21.2.0',
  './attendance.css?v=21.2.0',
  './fuel.css?v=21.2.0',
  './theme-green.css?v=21.2.0',
  './firebase-init.js?v=21.2.0',
  './offline-store.js?v=21.2.0',
  './push-notifications.js?v=21.2.0',
  './app.js?v=21.2.0',
  './charts.js?v=21.2.0',
  './chat.js?v=21.2.0',
  './attendance.js?v=21.2.0',
  './fuel.js?v=21.2.0',
  './operations.js?v=21.2.0',
  './manifest.json?v=21.2.0',
  './assets/logo.png',
