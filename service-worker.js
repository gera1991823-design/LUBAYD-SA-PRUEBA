/* Lubayd SA V20.8.3 - diseño V20.1 + asistencia offline + push */
const CACHE_NAME = 'lubayd-forestal-v20.8.3-offline-completo-1h';
const LOCAL_ASSETS = [
  './',
  './index.html',
  './style.css?v=20.8.3',
  './operations.css?v=20.8.3',
  './attendance.css?v=20.8.3',
  './firebase-init.js?v=20.8.3',
  './offline-store.js?v=20.8.3',
  './push-notifications.js?v=20.8.3',
  './app.js?v=20.8.3',
  './charts.js?v=20.8.3',
  './chat.js?v=20.8.3',
  './attendance.js?v=20.8.3',
  './operations.js?v=20.8.3',
  './manifest.json?v=20.8.3',
  './assets/logo.png',
