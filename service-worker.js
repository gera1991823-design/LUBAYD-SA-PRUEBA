/* Lubayd SA V21.0.0 - diseño V20.1 + asistencia offline + push */
const CACHE_NAME = 'lubayd-forestal-v21.0.0-ui-refresh';
const LOCAL_ASSETS = [
  './',
  './index.html',
  './style.css?v=21.0.0',
  ...
  './fuel.css?v=21.0.0',
  './ui-refresh.css?v=21.0.0',
  './firebase-init.js?v=21.0.0',
  './offline-store.js?v=21.0.0',
  './push-notifications.js?v=21.0.0',
  './app.js?v=21.0.0',
  './charts.js?v=21.0.0',
  './chat.js?v=21.0.0',
  './attendance.js?v=21.0.0',
  './fuel.js?v=21.0.0',
  './operations.js?v=21.0.0',
