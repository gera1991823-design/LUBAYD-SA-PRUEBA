/* Lubayd SA V20.8.8 - diseño V20.1 + asistencia offline + push */
const CACHE_NAME = 'lubayd-forestal-v20.8.8-fuel-offline';
const LOCAL_ASSETS = [
  './',
  './index.html',
  './style.css?v=20.8.8',
  './operations.css?v=20.8.8',
  './attendance.css?v=20.8.8',
  './fuel.css?v=20.8.8',
  './firebase-init.js?v=20.8.8',
  './offline-store.js?v=20.8.8',
  './push-notifications.js?v=20.8.8',
  './app.js?v=20.8.8',
  './charts.js?v=20.8.8',
  './chat.js?v=20.8.8',
  './attendance.js?v=20.8.8',
  './fuel.js?v=20.8.8',
  './operations.js?v=20.8.8',
  './manifest.json?v=20.8.8',
  './assets/logo.png',
