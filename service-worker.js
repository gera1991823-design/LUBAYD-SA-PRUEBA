/* Lubayd SA V20.8 - diseño V20.1 + asistencia offline + push */
const CACHE_NAME = 'lubayd-forestal-v20.8.0-offline-completo-1h';
const LOCAL_ASSETS = [
  './',
  './index.html',
  './style.css?v=20.8.0',
  './operations.css?v=20.8.0',
  './attendance.css?v=20.8.0',
  './firebase-init.js?v=20.8.0',
  './offline-store.js?v=20.8.0',
  './push-notifications.js?v=20.8.0',
  './app.js?v=20.8.0',
  './charts.js?v=20.8.0',
  './chat.js?v=20.8.0',
  './attendance.js?v=20.8.0',
  './operations.js?v=20.8.0',
  './manifest.json?v=20.8.0',
  './assets/logo.png',
