...
const CACHE_NAME = 'lubayd-forestal-v21.1.0-attendance-safari';
const LOCAL_ASSETS = [
  './',
  './index.html',
  './style.css?v=21.1.0',
  './operations.css?v=21.1.0',
  './attendance.css?v=21.1.0',
  './fuel.css?v=21.1.0',
  './ui-refresh.css?v=21.1.0',
  './firebase-init.js?v=21.1.0',
  './offline-store.js?v=21.1.0',
  './push-notifications.js?v=21.1.0',
  './app.js?v=21.1.0',
  './charts.js?v=21.1.0',
  './chat.js?v=21.1.0',
  './attendance.js?v=21.1.0',
  './fuel.js?v=21.1.0',
  './operations.js?v=21.1.0',
  './manifest.json?v=21.1.0',
  './assets/logo.png',
