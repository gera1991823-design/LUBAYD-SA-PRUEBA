/* Lubayd SA V20.8.7 - diseño V20.1 + asistencia offline + push */
const CACHE_NAME = 'lubayd-forestal-v20.8.7-offline-universal';
const LOCAL_ASSETS = [
  './',
  './index.html',
  './style.css?v=20.8.7',
  './operations.css?v=20.8.7',
  './attendance.css?v=20.8.7',
  './firebase-init.js?v=20.8.7',
  './offline-store.js?v=20.8.7',
  './push-notifications.js?v=20.8.7',
  './app.js?v=20.8.7',
  './charts.js?v=20.8.7',
  './chat.js?v=20.8.7',
  './attendance.js?v=20.8.7',
  './operations.js?v=20.8.7',
  './manifest.json?v=20.8.7',
  './assets/logo.png',
