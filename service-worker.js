/* Lubayd SA V20.8.2 - diseño V20.1 + asistencia offline + push */
const CACHE_NAME = 'lubayd-forestal-v20.8.2-offline-completo-1h';
const LOCAL_ASSETS = [
  './',
  './index.html',
  './style.css?v=20.8.2',
  './operations.css?v=20.8.2',
  './attendance.css?v=20.8.2',
  './firebase-init.js?v=20.8.2',
  './offline-store.js?v=20.8.2',
  './push-notifications.js?v=20.8.2',
  './app.js?v=20.8.2',
  './charts.js?v=20.8.2',
  './chat.js?v=20.8.2',
  './attendance.js?v=20.8.2',
  './operations.js?v=20.8.2',
  './manifest.json?v=20.8.2',
  './assets/logo.png',
