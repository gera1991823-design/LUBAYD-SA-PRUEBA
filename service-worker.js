/* Lubayd SA V20.9.1 - diseño V20.1 + asistencia offline + push */
const CACHE_NAME = 'lubayd-forestal-v20.9.1-fuel-offline';
const LOCAL_ASSETS = [
  './',
  './index.html',
  './style.css?v=20.9.1',
  './operations.css?v=20.9.1',
  './attendance.css?v=20.9.1',
  './fuel.css?v=20.9.1',
  './firebase-init.js?v=20.9.1',
  './offline-store.js?v=20.9.1',
  './push-notifications.js?v=20.9.1',
  './app.js?v=20.9.1',
  './charts.js?v=20.9.1',
  './chat.js?v=20.9.1',
  './attendance.js?v=20.9.1',
  './fuel.js?v=20.9.1',
  './operations.js?v=20.9.1',
  './manifest.json?v=20.9.1',
  './assets/logo.png',
