/* Lubayd SA V21.0.1 - diseño V20.1 + asistencia offline + push */
const CACHE_NAME = 'lubayd-forestal-v21.0.1-indexeddb-fix';
const LOCAL_ASSETS = [
  './',
  './index.html',
  './style.css?v=21.0.1',
  './operations.css?v=21.0.1',
  './attendance.css?v=21.0.1',
  './fuel.css?v=21.0.1',
  './ui-refresh.css?v=21.0.1',
  './firebase-init.js?v=21.0.1',
  './offline-store.js?v=21.0.1',
  './push-notifications.js?v=21.0.1',
  './app.js?v=21.0.1',
  './charts.js?v=21.0.1',
  './chat.js?v=21.0.1',
  './attendance.js?v=21.0.1',
  './fuel.js?v=21.0.1',
  './operations.js?v=21.0.1',
  './manifest.json?v=21.0.1',
  './assets/logo.png',
