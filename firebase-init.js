/* Lubayd SA V20.8.4 - Firebase, acceso offline multidispositivo y sesión controlada */
(function () {
  ...
  try {
    ...
    auth.setPersistence(firebase.auth.Auth.Persistence.SESSION).catch(function (error) {
